...
# ⚙️ إعداد المتغيرات
# ==============================
project_dir="E:/projects/c++ course/08 - Algorithms & Problem Solving Level 4/Project 2"
snapshot_dir="E:/projects/_snapshots_level_four"
repo_url="https://github.com/osama-mohamoud2006/Atm-System"
branch="main"
...
commit_msg="Auto commit (Project 2): $(date '+%Y-%m-%d %H:%M:%S')"
